...
class ATPEOptimizer:
    ...
    def __init__(self):
        try:
            ...
            raise ImportError("You must install lightgbm and sklearn in order to use the ATPE algorithm. Please run `pip install lightgbm` and `pip install scikit-learn` and try again. These are not built in dependencies of hyperopt.")
