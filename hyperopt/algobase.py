...
def make_suggest_many_from_suggest_one(suggest_one):
    ...
    N predictions are generated by iteratively adding the previous suggested
    points into a temporary Trials object, and feeding that temporary trials
    object to remaining suggest() calls.
    """
